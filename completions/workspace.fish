set -l subcommands init add rm remove ls list co checkout mv move

complete -c workspace -n "not __fish_seen_subcommand_from $subcommands; and not __fish_seen_subcommand_from (_workspace_associated_branches)" -a move -d "rename branch"
complete -c workspace -n "not __fish_seen_subcommand_from $subcommands; and not __fish_seen_subcommand_from (_workspace_associated_branches)" -a remove -d "delete branch"
...
complete -c workspace -n "__fish_seen_subcommand_from rm remove mv move; and not __fish_seen_subcommand_from (_workspace_associated_branches)" -a "(_workspace_associated_branches)"
